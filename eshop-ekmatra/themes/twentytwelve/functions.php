...
function twentytwelve_scripts_styles() {
	...
	wp_enqueue_style( 'mytheme', get_template_directory_uri() . '/css/ekmatra.css', array( 'twentytwelve-style' ), '20121010' );
...
add_action( 'customize_preview_init', 'twentytwelve_customize_preview_js' );
	...
	register_sidebar( array(
		'name' => __( 'Listingpagewomencategorywidget', 'twentytwelve' ),
		'id' => 'listingpagewomencategorywidget',
		'description' => __( 'Appears when using the optional Front Page template with a page set as Static Front Page', 'twentytwelve' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h3 class="widget-title">',
...
add_filter( 'woocommerce_billing_fields', 'wc_npr_filter_billing', 20, 1 );
add_filter( 'woocommerce_shipping_fields', 'wc_npr_filter_shipping', 20, 1 );
function wc_npr_filter_billing( $address ) {
	...
	// $address['billing_postcode']['label']='Enter zip/pin code';
	// $address['billing_phone']['label']='Contact No';      
	...
	// unset($address['order']['order_comments']);
