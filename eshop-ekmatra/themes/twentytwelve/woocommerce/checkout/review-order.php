	...
	<table class="shop_table">
		...
		<thead>
			...
			<tr>
                ...
                <th class="product-info"><?php _e( '', 'woocommerce' ); ?></th>
		...
		<tfoot>
			...
			<tr class="discount">
            	...
            	<th  colspan="3"><?php _e( 'Cart Discount', 'woocommerce' ); ?></th>
					...
					if ( sizeof( $taxes ) > 0 ) {
						...
						foreach ( $taxes as $key => $tax ) {
							...
							<tr class="tax-rate tax-rate-<?php echo $key; ?>">
                            	...
                            	<th  colspan="3"><?php echo $woocommerce->cart->tax->get_rate_label( $key ); ?></th>
						...
						<tr class="tax">
                        	...
                        	<th  colspan="3"><?php _e( 'Tax', 'woocommerce' ); ?></th>
			...
			<tr class="total">
            	...
            	<th colspan="3"><strong><?php _e( 'Total', 'woocommerce' ); ?></strong></th>
						...
						if ($_product->exists() && $values['quantity']>0) :
							...
							echo '<tr class="' . esc_attr( apply_filters('woocommerce_checkout_table_item_class', 'checkout_table_item', $values, $cart_item_key ) ) . '">
									...
									<td class="product-image">';
										...
										echo  $thumbnail = apply_filters( 'woocommerce_in_cart_product_thumbnail', $_product->get_image(), $values, $cart_item_key );

                                     echo'</td>
									 
									 <td class="product-info">' .
									 apply_filters( 'woocommerce_checkout_product_title', $_product->get_title(), $_product ) . ' ' .' <div class="productcode">'. $woocommerce->cart->get_item_data( $values ).'</div>'.'</td>


									<td class="product-qty">' .
									'<div class="qty">' .apply_filters( 'woocommerce_checkout_item_quantity', '<strong class="product-quantity">' . $values['quantity'] . '</strong>', $values, $cart_item_key ).'</div>'.'</td>
