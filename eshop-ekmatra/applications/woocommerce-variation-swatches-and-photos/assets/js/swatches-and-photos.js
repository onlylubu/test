...
$('.product_title').html(variation_title);
        } else {
            $(img).attr('src', o_src);
...
$('.product_title').html(o_title);
        }
        var imagesize=jQuery('#imagesize').val();
        var largeimagename=imagename.replace('-'+imagesize,'');        
        jQuery('.wp-post-image').attr('data-o_src',imagename);
        jQuery('.MagicZoomPlus').attr('href',largeimagename);
        jQuery('.MagicZoomBigImageCont img').attr('src',largeimagename);
        jQuery('.MagicThumb-expanded img').attr('src',largeimagename);
    }
